...
class DisplayManager:
    def __init__(self, config):
        ...
        services = ["stream", "library", "playlists", "qobuz", "tidal", "spop", "spotify", "webradio", "motherearthradio", "radio_paradise", "mpd", "default", "nas", "usb", "back", "config", "irremote", "volume", "displaysettings", "clocksettings", "screensaversettings", "systeminfo", "systemupdate"]
